    ...
    <>
      ...
      <div className="flex flex-col items-center py-10 w-[384px]">
        ...
        <button 
          ...
          type="button"
          className="py-2 px-6 mt-6 bg-zinc-100 dark:bg-zinc-800 hover:bg-zinc-200 dark:hover:bg-zinc-700 text-zinc-800 dark:text-zinc-100 rounded-md border-transparent text-sm leading-6 transition-colors focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-zinc-900 focus:ring-brand-500"
        >
          Quero enviar outro
        </button>
      </div>
